            ...
            <tbody>
                @foreach ($evaluations as $key => $evaluation)
                    <tr>
                        ...
                        <td>{{ $evaluation['course']['nombre'] }}</td>
                        <td>{{ $evaluation['name'] }}</td>
                        <td>{{ $evaluation['typeEvaluation']['nombre'] }}</td>
                        <td>{{ $evaluation['conceptStudent']['nameStudentConcept']['nombre'] }}</td>
                        <td>{{ $evaluation['conceptStudent']['observaciones'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
